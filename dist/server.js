...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
		...
		server: function server() {
			...
			this.side = 'server';
			peer = new _peerjs2['default']('server', { key: 'ygsnnfll7ovibe29' });
		...
		client: function client() {
			peer = new _peerjs2['default']({ key: 'ygsnnfll7ovibe29' });
			peer.on('open', function (id) {
				console.log('server id ' + id);
			});
			var connection = peer.connect('server');
	...
	module.exports = 2;
	console.log('DOES THIS COME AFTER?');
